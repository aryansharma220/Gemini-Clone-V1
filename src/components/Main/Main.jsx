      ...
      <div className="main-container">
        {!showResult ?
          <>
            ...
            <div className="cards">
              <div className="card">
                <p>Suggest beautiful paces to see on an upcoming road trip</p>
        ...
        <div className="main-bottom">
          ...
          <p className='bottom-info'>
            Gemini may display inaccurate info, including about people, so double-check its responses. <span style={{ textDecoration: 'underline' }}> Your privacy and Gemini Apps</span>
          </p>
        </div>
      </div>
